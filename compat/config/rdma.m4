...
[
	...
	AC_MSG_CHECKING([if ethtool has phys_id])
	MLNX_BG_LB_LINUX_TRY_COMPILE([
		#include <linux/ethtool.h>
	],[
		const struct ethtool_ops en_ethtool_ops = {
	...
	*)
	...
	AC_MSG_CHECKING([if netdev_select_queue exist])
	MLNX_BG_LB_LINUX_TRY_COMPILE([
		#include <linux/netdevice.h>
		...
		AC_MSG_RESULT(yes)
		MLNX_AC_DEFINE(HAVE_NETDEV_SELECT_QUEUE, 1,
			  [netdev_select_queue exist])
	],[
		AC_MSG_RESULT(no)
	])
	...
	AC_MSG_CHECKING([if struct ethtool_ops_ext has get/set_sg])
	MLNX_BG_LB_LINUX_TRY_COMPILE([
		#include <linux/ethtool.h>
	],[
		const struct ethtool_ops_ext en_ethtool_ops_ext = {
		...
		AC_MSG_RESULT(yes)
		MLNX_AC_DEFINE(HAVE_GET_SET_SG_EXT, 1,
			  [get/set_sg is defined in ethtool_ops_ext])
	],[
		AC_MSG_RESULT(no)
	])
	...
	AC_MSG_CHECKING([if struct ethtool_ops_ext has get/set_tx_csum])
	MLNX_BG_LB_LINUX_TRY_COMPILE([
		#include <linux/ethtool.h>
	],[
		const struct ethtool_ops_ext en_ethtool_ops_ext = {
		...
		AC_MSG_RESULT(yes)
		MLNX_AC_DEFINE(HAVE_GET_SET_TX_CSUM_EXT, 1,
			  [get/set_tx_csum is defined in ethtool_ops_ext])
	],[
		AC_MSG_RESULT(no)
	])
	...
	AC_MSG_CHECKING([if struct ethtool_ops_ext has get/set_rx_csum])
	MLNX_BG_LB_LINUX_TRY_COMPILE([
		#include <linux/ethtool.h>
	],[
		const struct ethtool_ops_ext en_ethtool_ops_ext = {
		...
		AC_MSG_RESULT(yes)
		MLNX_AC_DEFINE(HAVE_GET_SET_RX_CSUM_EXT, 1,
			  [get/set_rx_csum is defined in ethtool_ops_ext])
	],[
		AC_MSG_RESULT(no)
	])
...
#	])
	...
	MLNX_BG_LB_LINUX_TRY_COMPILE([
		...
		AC_MSG_RESULT(yes)
		MLNX_AC_DEFINE(HAVE_NS_TO_TIMESPEC64, 1,
